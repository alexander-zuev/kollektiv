...
class ToolUseBlock(ContentBlock):
    ...
    text: str | None = Field(None, description="Optional text description of tool use")
...
class ToolResultBlock(ContentBlock):
    ...
    is_error: bool | None = Field(None, description="Whether this result represents an error")
    text: str | None = Field(None, description="Optional text description of the result")


class MessageContent(BaseModel):
    """Content of a conversation message."""

    blocks: list[TextBlock | ToolUseBlock | ToolResultBlock] = Field(..., description="List of content blocks")
...
class ConversationMessage(BaseDbModel):
    ...
    conversation_id: UUID | None = Field(
        None,
        description=("FK reference to a conversation. Must be created before saving a message."),
    )
...
class ConversationHistory(BaseModel):
    ...
    def append(self, role: Role | str, content: str | MessageContent) -> None:
        ...
        message = ConversationMessage(conversation_id=self.conversation_id, role=role, content=content)
