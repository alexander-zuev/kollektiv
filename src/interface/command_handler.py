...
# TODO: abstract command reply to be a pydantic class
...
class CommandHandler:
    ...
    Attributes:
        ...
        flow_manager (UserInputManager): Manages input flow for multi-step input collection.
    ...
    def __init__(self, kollektiv: "Kollektiv", flow_manager: UserInputManager):
    ...
    async def handle_docs_command(self, command_parts: list) -> str:
        ...
        if action == "add":
            ...
            return self.remove_web_content(command_parts[1:])
    ...
    async def add_web_content(self, args: list) -> str:
        ...
        # TODO: Why this validation is done in add_web_content?
        if not args:
            return (
    ...
    async def process_flow_input(self, user_input: str) -> dict:
        ...
        if result["done"]:
            ...
            kollektiv_result = await self.kollektiv.index_web_content(**flow_data)
