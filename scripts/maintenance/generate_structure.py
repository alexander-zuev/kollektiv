...
def generate_project_structure(root_dir, output_file, ignore_dirs=None, ignore_files=None) -> None:
    """
...
if __name__ == "__main__":
    # Get the current working directory instead of relative to script location
    project_root = Path.cwd()
    output_file = project_root / "scripts" / "maintenance" / "project_structure.txt"
